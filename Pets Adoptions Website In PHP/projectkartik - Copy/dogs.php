...
<div class="container" id="showdata">
      ...
      $conn=new mysqli('localhost','root','','pets_adoption');
          $sql = "SELECT *FROM animal inner join shelter where animal.Shelter_ID=shelter.Shelter_ID and Animal_Type='dog' and animal.Status='Not Accepted'";
